const OfferCardSkeleton = () => {
  return (
    <div className="border border-[#F5F6F6] bg-white min-w-[148px] sm:min-w-[190px] sm:h-[262px] lg:h-[262px] lg:w-full rounded-xl p-3 sm:p-4 flex flex-col items-end lg:gap-3 shadow-[0px_2px_55px_-1px_rgba(113,113,113,0.12)] animate-pulse">
      ...
      <div className="w-full flex flex-col gap-2 lg:gap-3 flex-1">
        ...
        <div className="flex flex-col h-full justify-end">
          <div className="flex items-end lg:items-center h-[34px] sm:h-[48px] w-full justify-between gap-4">
